...
\begin{frame}{Fundamentação}{Testes de Integração}
  \begin{itemize}
    ...
    \item Consistência dos estados entre operações.
    % Muitos erros de integração ocorrem justamente nessas transições de estados intermediários.
...
\begin{frame}{Método Proposto}{Modelagem do Comportamento}
  \begin{itemize}
    \item Modelagem do fluxo de onboarding como sistema de estados.
    \item Cada etapa representada como processo.
    \begin{figure}[hb]
	    \resizebox{0.9\textwidth}{!}{
        \input{img/MiniDiagrama_fluxo.tikz}
      }
    \end{figure}
    \item Estados do sistema explicitados por variáveis de controle.
    \item Transições representam chamadas reais da API REST.
  \end{itemize}
\end{frame}
...
\end{center}
%Sempre que carrossel_ok ocorrer, então em algum momento no futuro senha_definida deverá ocorrer.
...
\begin{frame}{Estudo de Caso}{Aplicativo e-Título}
  \begin{itemize}
    ...
    \resizebox{0.8\textwidth}{!}{
	    \input{img/EstadosOnBoarding.tikz}
    }
