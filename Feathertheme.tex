...
{      Luís Fernando Marzola da Cunha \\
      {\ttfamily fernandoluismc@gmail.com}
}

\institute[]
{
      Engenharia Aeroespacial, Faculdade do Gama\\
...
\section{Introdução}
%-------------------------------------------------------
\subsection{Tipos de Queimadores}
\begin{frame}{Introdução}{Queimadores}
%-------------------------------------------------------

  \begin{itemize}
      \item O que são?
      \item Onde são usados?
      \item Tipos de Queimadores
  \end{itemize}
...
\begin{frame}{Introdução}{Queimadores Atmosféricos}


  \begin{itemize}
      \item O que são?
      \item Onde são usados?
      \item Tipos de Queimadores Atmosféricos
  \end{itemize}
